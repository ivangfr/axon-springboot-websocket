...
class RestaurantAggregateTest {
  ...
  void testUpdateRestaurant() {
    String id = UUID.randomUUID().toString();
    fixture
        .given(new RestaurantAddedEvent(id, "Pizza Hut"))
  ...
  void testAddRestaurantDish() {
    ...
    fixture
        .given(new RestaurantAddedEvent(restaurantId, "Pizza Hut"))
        .when(
            new AddRestaurantDishCommand(
                restaurantId, dishId, "Pizza Margherita", new BigDecimal("6.99")))
        .expectEvents(
            new RestaurantDishAddedEvent(
                restaurantId, dishId, "Pizza Margherita", new BigDecimal("6.99")));
  }
    ...
    fixture
        ...
        .when(
            new UpdateRestaurantDishCommand(
                restaurantId, dishId, "Pizza Margherita 35cm", new BigDecimal("7.99")))
        .expectEvents(
            new RestaurantDishUpdatedEvent(
                restaurantId, dishId, "Pizza Margherita 35cm", new BigDecimal("7.99")));
  }
  ...
  void testUpdateRestaurantDish_whenNameNull_keepsOriginalName() {
    ...
    fixture
        ...
        .expectEvents(
            new RestaurantDishUpdatedEvent(
                restaurantId, dishId, "Pizza Margherita", new BigDecimal("7.99")));
  }
  ...
  void testUpdateRestaurantDish_whenPriceNull_keepsOriginalPrice() {
    ...
    fixture
        ...
        .expectEvents(
            new RestaurantDishUpdatedEvent(
                restaurantId, dishId, "Pizza Margherita 35cm", new BigDecimal("6.99")));
  }
  ...
  void testUpdateRestaurantDish_whenDishNotFound_throwsException() {
    ...
    fixture
        ...
        .when(
            new UpdateRestaurantDishCommand(
                restaurantId, "nonexistent", "Updated", new BigDecimal("9.99")))

...
class RestaurantDtoJsonTest {
  ...
  @Autowired private JacksonTester<AddRestaurantRequest> addRestaurantRequestJson;

  @Autowired private JacksonTester<UpdateRestaurantRequest> updateRestaurantRequestJson;

  @Autowired private JacksonTester<AddRestaurantDishRequest> addRestaurantDishRequestJson;

  @Autowired private JacksonTester<UpdateRestaurantDishRequest> updateRestaurantDishRequestJson;

  @Autowired private JacksonTester<RestaurantResponse> restaurantResponseJson;

  @Autowired private JacksonTester<DishResponse> dishResponseJson;

  @Autowired private JacksonTester<RestaurantOrderResponse> restaurantOrderResponseJson;
  ...
  void testAddRestaurantDishRequestSerialization() throws Exception {
    AddRestaurantDishRequest request =
        new AddRestaurantDishRequest("Pizza Margherita", new BigDecimal("6.99"));
  ...
  void testUpdateRestaurantDishRequestSerialization() throws Exception {
    UpdateRestaurantDishRequest request =
        new UpdateRestaurantDishRequest("Pizza Margherita 35cm", new BigDecimal("7.99"));
  ...
  void testDishResponseSerialization() throws Exception {
    DishResponse response =
        new DishResponse("r1", "d1", "Pizza Margherita", new BigDecimal("6.99"));
  ...
  void testRestaurantOrderResponseSerialization() throws Exception {
    RestaurantOrderResponse.OrderItem item =
        new RestaurantOrderResponse.OrderItem(
            "d1", "Pizza Margherita", new BigDecimal("6.99"), (short) 2);
    RestaurantOrderResponse response =
        new RestaurantOrderResponse(
            "o1",
            "John",
            "123 Main St",
            "CREATED",

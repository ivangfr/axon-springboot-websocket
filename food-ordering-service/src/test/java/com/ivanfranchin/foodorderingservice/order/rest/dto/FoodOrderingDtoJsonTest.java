...
class FoodOrderingDtoJsonTest {
    ...
    @Autowired
    private JacksonTester<CreateOrderRequest> createOrderRequestJson;

    @Autowired
    private JacksonTester<OrderResponse> orderResponseJson;
    ...
    @Autowired
    private JacksonTester<OrderCreatedEvent> orderCreatedEventJson;

    @Test
    void testCreateOrderRequestSerialization() throws Exception {
        CreateOrderRequest.OrderItemRequest item = new CreateOrderRequest.OrderItemRequest(
                java.util.UUID.randomUUID(), (short) 2);
    ...
    void testOrderResponseSerialization() throws Exception {
        ...
        OrderResponse response = new OrderResponse(
                "o1", "c1", "John", "123 Main St", "r1", "Pizza Hut",
                com.ivanfranchin.foodorderingservice.order.model.OrderStatus.CREATED,
                new BigDecimal("13.98"), ZonedDateTime.parse("2025-01-15T10:30:00Z"), Set.of(item));
        ...
        assertThat(json).extractingJsonPathStringValue("$.items[0].dishName").isEqualTo("Pizza Margherita");
    }

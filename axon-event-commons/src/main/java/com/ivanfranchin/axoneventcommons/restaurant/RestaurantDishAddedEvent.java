...
public class RestaurantDishAddedEvent implements RestaurantEvent {
    ...
    public RestaurantDishAddedEvent() {
    }

    public RestaurantDishAddedEvent(String restaurantId, String dishId, String dishName, BigDecimal dishPrice) {
    ...
    public boolean equals(Object o) {
        ...
        RestaurantDishAddedEvent that = (RestaurantDishAddedEvent) o;
    ...
    public String toString() {
        return "RestaurantDishAddedEvent{" +
